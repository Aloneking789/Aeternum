import type { Property, Investment, Listing, UserProfile, ActivityItem } from '@/types';
...
export const MOCK_PROPERTIES: Property[] = [
  {
    ...
    description: 'A landmark 42-floor residential tower in the heart of Downtown Dubai featuring luxury apartments with panoramic views of Burj Khalifa and The Dubai Fountain. Premium amenities include infinity pool, concierge, and private cinema.',
  ...
  },
  {
    ...
    description: 'Historic Victorian mansion fully restored with modern interiors in San Francisco\'s most prestigious neighborhood. Features 8 bedrooms, formal gardens, wine cellar, and stunning bay views.',
  ...
  },
  {
    ...
    city: 'London',
    type: 'Commercial',
    image: 'https://images.unsplash.com/photo-1575517111478-7f6afd0973db?w=800&q=80',
    images: [
      'https://images.unsplash.com/photo-1575517111478-7f6afd0973db?w=800&q=80',
      'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=80',
      'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80',
    ],
    description: 'Grade-A office building in the prestigious Canary Wharf financial district. Fully leased to Fortune 500 tenants with 15-year agreements. LEED Gold certified sustainable building.',
  ...
  },
  {
    ...
    description: 'Ultra-luxury waterfront suites with direct marina access. Each unit features floor-to-ceiling glass, smart home automation, and a private yacht berth. Managed by Six Senses Hotels.',
  ...
  },
  {
    ...
    description: 'Modern last-mile logistics facility strategically located near Côte d\'Azur International Airport. 100% leased to Amazon Logistics with 10-year triple net lease.',
  ...
  },
  {
    ...
    description: 'Premium mixed-use development combining luxury residences, boutique retail, and co-working spaces in Sydney\'s iconic waterfront precinct. Award-winning sustainable architecture.',
...
export const MOCK_INVESTMENTS: Investment[] = [
  {
    ...
    propertyImage: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=800&q=80',
    sharesOwned: 500,
    pricePerShare: 100,
    purchasePrice: 50000,
    currentValue: 53450,
  ...
  },
  {
    ...
    propertyImage: 'https://images.unsplash.com/photo-1575517111478-7f6afd0973db?w=800&q=80',
    sharesOwned: 200,
    pricePerShare: 250,
    purchasePrice: 50000,
    currentValue: 54750,
  ...
  },
  {
    ...
    propertyImage: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80',
    sharesOwned: 1250,
    pricePerShare: 40,
    purchasePrice: 50000,
    currentValue: 51800,
...
export const MOCK_ACTIVITY: ActivityItem[] = [
  { id: 'act_001', type: 'investment', user: '3xMp...k9Wz', amount: 12500, shares: 125, date: '2h ago' },
  { id: 'act_002', type: 'yield', user: '8qLr...fV2n', amount: 840, date: '5h ago' },
  { id: 'act_003', type: 'investment', user: 'Kp7Y...nQ4s', amount: 25000, shares: 100, date: '8h ago' },
  { id: 'act_004', type: 'transfer', user: 'wN9T...hX1m', amount: 5000, shares: 50, date: '1d ago' },
  { id: 'act_005', type: 'investment', user: 'zR2B...jL6p', amount: 8000, shares: 80, date: '1d ago' },
];

export const WALLET_OPTIONS = [
  { id: 'phantom', name: 'Phantom', icon: '👻', description: 'Most popular Solana wallet' },
  { id: 'solflare', name: 'Solflare', icon: '🔆', description: 'Native Solana wallet' },
  { id: 'backpack', name: 'Backpack', icon: '🎒', description: 'Multi-chain wallet' },
  { id: 'glow', name: 'Glow', icon: '✨', description: 'Beautiful & secure' },
];

export const COUNTRIES = [
  'Afghanistan', 'Australia', 'Bahrain', 'Brazil', 'Canada', 'China', 'Egypt',
  'France', 'Germany', 'India', 'Indonesia', 'Japan', 'Kuwait', 'Malaysia',
  'Netherlands', 'New Zealand', 'Nigeria', 'Norway', 'Oman', 'Pakistan',
  'Qatar', 'Saudi Arabia', 'Singapore', 'South Korea', 'Spain', 'Sweden',
  'Switzerland', 'Thailand', 'UAE', 'UK', 'USA',
];
