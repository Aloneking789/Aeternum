          ...
          <View style={styles.tabContent}>
            <View style={styles.overviewStats}>
              {[
                ...
                { label: 'Price/Share', value: formatCurrency(property.pricePerShare) },
                { label: 'Available Shares', value: property.availableShares.toLocaleString() },
                { label: 'Total Investors', value: property.totalInvestors.toLocaleString() },
            ...
            <View style={styles.progressSection}>
              <View style={styles.progressHeader}>
                <Text style={styles.progressLabel}>Shares Available</Text>
              ...
              <View style={styles.progressFooter}>
                ...
                <Text style={styles.progressInfo}>
                  {(property.totalShares - property.availableShares).toLocaleString()} shares already sold
                </Text>
              </View>
            </View>

            <View style={styles.descSection}>
              <Text style={styles.descTitle}>About this Property</Text>
        ...
        {activeTab === 'Financials' && (
          <View style={styles.tabContent}>
            <View style={styles.financeCard}>
              <Text style={styles.financeTitle}>Monthly Income Breakdown</Text>
              {[
                { label: 'Monthly Rental Income', value: formatCurrency(property.monthlyRental), color: Colors.green },
                ...
                { label: 'Insurance', value: `-${formatCurrency(property.insuranceCost)}`, color: Colors.red },
              ].map((row) => (
              ...
              <View style={styles.financeRow}>
                <Text style={styles.financeNetLabel}>Net Distributable Income</Text>
            ...
            <View style={styles.financeCard}>
              ...
              {[
                { label: 'Annual Yield', value: `${property.yieldPercent}%`, color: Colors.gold },
                { label: 'Cap Rate', value: `${property.capRate}%`, color: Colors.cyan },
                { label: 'Occupancy Rate', value: `${property.occupancy}%`, color: Colors.green },
                { label: 'Annual Income', value: formatCurrency(netYield * 12, true), color: Colors.text },
              ].map((row) => (
                <View key={row.label} style={styles.financeRow}>
                  <Text style={styles.financeLabel}>{row.label}</Text>
                  <Text style={[styles.financeVal, { color: row.color }]}>{row.value}</Text>
      ...
      <View style={[styles.buyBar, { paddingBottom: insets.bottom + 12 }]}>
        ...
        <View style={styles.buyBarContent}>
          <View>
            ...
            <Text style={styles.buyBarLabel}>per share</Text>
          </View>
          <TouchableOpacity
            style={styles.buyBtn}
          ...
          >
            <LinearGradient colors={['#D4AF37', '#A88C28']} style={styles.buyBtnGrad}>
              <Text style={styles.buyBtnText}>Buy Shares</Text>
