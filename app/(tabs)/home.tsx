      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
          <View style={styles.heroCard}>
            ...
            <View style={styles.heroStats}>
              {[
                ...
                { label: 'Yield Earned', value: formatCurrency(totalYieldEarned, true) },
          ...
          {totalClaimable > 0 && (
            ...
            >
              ...
              <View style={styles.claimLeft}>
                ...
                <View>
                  <Text style={styles.claimTitle}>Yield Available to Claim</Text>
          ...
          <View style={styles.actionsGrid}>
            {[
              { label: 'Explore', sub: 'Properties', icon: Layers, color: Colors.cyan, route: '/(tabs)/explore' as any },
              { label: 'Claim', sub: 'Yield', icon: Zap, color: Colors.green, route: '/claim' as any },
              { label: 'List', sub: 'Property', icon: Building2, color: Colors.gold, route: '/list/step1' as any },
              { label: 'Portfolio', sub: 'My Invest', icon: TrendingUp, color: Colors.purple, route: '/(tabs)/investments' as any },
            ].map((a) => (
              <TouchableOpacity
                key={a.label}
