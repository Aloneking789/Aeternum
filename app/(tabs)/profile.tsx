      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={styles.statsGrid}>
          {[
            ...
            { label: 'Total Invested', value: formatCurrency(totalInvested, true), icon: Zap, color: Colors.cyan },
            { label: 'Yield Earned', value: formatCurrency(totalYieldEarned, true), icon: Award, color: Colors.green },
            { label: 'Properties', value: `${listings.length}`, icon: Building2, color: Colors.purple },
          ].map((s) => (
