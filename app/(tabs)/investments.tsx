    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <Text style={styles.exploreBtnText}>Invest</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryGrid}>
            {[
              { label: 'Total Invested', value: formatCurrency(totalInvested), color: Colors.cyan },
              { label: 'Yield Earned', value: formatCurrency(totalYieldEarned), color: Colors.green },
              { label: 'Claimable', value: formatCurrency(totalClaimable), color: Colors.gold },
              { label: 'Properties', value: `${investments.length}`, color: Colors.purple },
            ].map((s) => (
        ...
        {totalClaimable > 0 && (
          ...
          >
            ...
            <View style={styles.claimLeft}>
              ...
              <View>
                <Text style={styles.claimTitle}>Claimable Yield Ready</Text>
        ...
        <Text style={styles.sectionTitle}>My Investments ({investments.length})</Text>

        {investments.length === 0 ? (
          <View style={styles.emptyState}>
            <Text style={styles.emptyIcon}>📈</Text>
            <Text style={styles.emptyTitle}>No investments yet</Text>
            <Text style={styles.emptyText}>Start investing in tokenized real estate to build your portfolio</Text>
            <TouchableOpacity
            ...
            return (
              <View key={inv.id} style={styles.invCard}>
                <View style={styles.invHeader}>
                  ...
                  <View style={styles.invInfo}>
                    ...
                    <Text style={styles.invDate}>
                      {inv.sharesOwned} shares · Invested {inv.investedAt}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.yieldRow}>
                  <View>
                    <Text style={styles.yieldEarned}>Yield Earned: {formatCurrency(inv.yieldEarned)}</Text>
