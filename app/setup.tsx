...
export default function SetupScreen() {
  ...
  const { setup, isSettingUp, walletAddress } = useWallet();
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Set up your profile to begin investing in tokenized real estate
          </Text>
        </View>
          ...
          <View style={styles.toggleRow}>
            <View style={styles.toggleLeft}>
              ...
              <View>
                ...
                <Text style={styles.toggleSub}>Yield alerts & investment updates</Text>
              </View>
            </View>
            <Switch
              value={notifications}
