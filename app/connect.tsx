      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Connect your Solana wallet to start investing in tokenized real estate
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <Text style={styles.checkText}>
              I understand that investing in tokenized real estate involves financial risk and I may lose invested capital
            </Text>
          </TouchableOpacity>
        </View>
