...
import { ArrowLeft, Zap, Calendar, Wallet, Shield, Check } from 'lucide-react-native';
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Claim Yield</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        <View style={styles.heroSection}>
          ...
          <Text style={styles.claimLabel}>CLAIMABLE YIELD</Text>
          <Text style={styles.claimAmount}>{formatCurrency(totalClaimable)}</Text>
          <Text style={styles.claimSubtitle}>
            From {claimableItems.length} propert{claimableItems.length === 1 ? 'y' : 'ies'}
          </Text>
        </View>
        ...
        <View style={styles.breakdownSection}>
          ...
          {claimableItems.map((inv) => (
            <View key={inv.id} style={styles.invRow}>
              ...
              <View style={styles.invInfo}>
                ...
                <Text style={styles.invShares}>{inv.sharesOwned} shares</Text>
              </View>
          ...
          {claimableItems.length === 0 && (
            <View style={styles.emptyYield}>
              <Text style={styles.emptyYieldText}>No claimable yield at this time</Text>
              <Text style={styles.emptyYieldSub}>Yields are distributed monthly</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.processSection}>
          ...
          {[
            ...
            { step: '2', text: 'Smart contract verifies ownership', icon: '🔐' },
            { step: '3', text: 'USDC transferred to your wallet', icon: '💸' },
          ].map((s) => (
        ...
        <View style={styles.securityRow}>
          ...
          <Text style={styles.securityText}>
            Non-custodial claim · Your yield, your control · Instant USDC settlement
          </Text>
        </View>
      </ScrollView>
