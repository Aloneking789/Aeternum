...
import {
  View, Text, StyleSheet, TouchableOpacity, ScrollView, Switch, Alert, Platform,
} from 'react-native';
import { useRouter } from 'expo-router';
import { LinearGradient } from 'expo-linear-gradient';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import {
  ArrowLeft, Bell, Fingerprint, Moon, Wifi, LogOut,
  ChevronRight, Shield, HelpCircle, FileText, Globe,
...
export default function SettingsScreen() {
  ...
  const handleDisconnect = () => {
    Alert.alert(
      'Disconnect Wallet',
      'Are you sure you want to disconnect? You will need to reconnect to access your portfolio.',
      [
          ...
          <View style={styles.settingRow}>
            <View style={styles.settingLeft}>
              ...
              <View>
                ...
                <Text style={styles.settingSub}>Yield alerts, investment updates</Text>
              </View>
            </View>
            <Switch
              value={notifications}
