  ...
  if (isSuccess) {
    return (
      <View style={[styles.successScreen, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
        ...
        <Text style={styles.successRedirect}>Redirecting to My Listings...</Text>
      </View>
    );
  }
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: 120 }}>
        ...
        <Text style={styles.subtitle}>Review your listing before submitting for approval</Text>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <Text style={styles.checkText}>
              I agree to the AETURNUM Tokenization Terms and understand the legal obligations of listing a property
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.reviewNote}>
          ...
          <Text style={styles.reviewNoteText}>
            Our compliance team will review your property listing within 3-5 business days. You'll receive notifications about your listing status. Once approved, your property goes live on the marketplace.
          </Text>
        </View>
      </ScrollView>
