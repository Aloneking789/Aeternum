    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {isLoading ? (
        <View style={styles.centerState}>
          ...
          <Text style={styles.centerText}>Loading draft details...</Text>
        </View>
      ) : error ? (
        <View style={styles.centerState}>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Step 1: Property Info</Text>
          ...
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Step 3: Media</Text>
            {imageUrls.length > 0 ? (
