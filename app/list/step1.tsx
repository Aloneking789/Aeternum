      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: 100 }} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputFlex}>
              ...
              <TextInput
                ...
                placeholder="e.g. Azure Skyline Tower"
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputFlex}>
              <Text style={styles.inputLabel}>Total Property Value (USD) *</Text>
              <TextInput
                style={styles.input}
                value={totalValue}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.textAreaGroup}>
            <Text style={styles.textAreaLabel}>Property Description * (min 10 chars)</Text>
            <TextInput
              style={styles.textArea}
              value={description}
              onChangeText={setDescription}
              placeholder="Describe the property, its features, location advantages..."
              placeholderTextColor={Colors.textDisabled}
              multiline
              numberOfLines={4}
            />
